...
parser.add_argument('--root_path', type=str, default='Case/DARWIN/DARWIN_AG/', help='root path of the data file')
...
parser.add_argument('--c_out', type=int, default=15, help='output size') #14sensors+1HI
