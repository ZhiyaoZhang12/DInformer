...
for i in range(len(rate_data_iter)):
    ...
    parser.add_argument('--model_name', type=str, required=False, default='informer',help='model of experiment, options: [informer, informerstack, informerlight(TBD),dcnn,biLSTM,transgcu]')
