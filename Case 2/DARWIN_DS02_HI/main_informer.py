...
for i in range(len(pred_len_iter)): 
    ...
    parser.add_argument('--model', type=str, required=False, default='informer',help='model of experiment, options: [informer, informerstack, DARWIN, informerlight(TBD),dcnn,biLSTM,transgcu]')
    ...
    parser.add_argument('--ag_data_len', type=int, default=4096, help='length of ag data') #2048;512
    parser.add_argument('--ag_seq_len', type=int, default=1024, help='length of ag data')
    ...
    for ii in range(args.itr):     
        ...
        ###################################################
        ###################################################
        if args.pred_len in [32,64,128,256]:
            break
        
        #if args.pred_len==256 and ii<=8:
        #    continue
        ###################################################
        ###################################################
