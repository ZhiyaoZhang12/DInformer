...
import pandas as pd
import numpy as np
from exp.exp_informer_1 import Exp_Informer_1
...
parser.add_argument('--seq_len', type=int, default=148, help='input sequence length of Informer encoder')
parser.add_argument('--label_len', type=int, default=148, help='start token length of Informer decoder')
...
#out=14 + 1HI
parser.add_argument('--c_out', type=int, default=15, help='output size')
...
for ii in range(args.itr):     
    setting = '{}_{}_ft{}_sl{}_ll{}_pl{}_lr{}_bs{}_dm{}_nh{}_el{}_dl{}_df{}_at{}_fc{}_eb{}_dt{}_mx{}_{}_{}'.format(args.model, args.HI_labeling_style, args.features, 
            args.seq_len, args.label_len, args.pred_len,args.learning_rate,args.batch_size,
