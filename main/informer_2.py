...
from exp.exp_informer_2 import Exp_Informer_2
...
for i in range(len(pred_len_iter)):
    ...
    for ii in range(args.itr): 
        #setting
        setting = '{}_sl{}ll{}pl{}bs{}nh{}at{}fc{}dt{}ispa{}ag{}de{}pe{}nor{}_{}{}'.format(args.model,
            args.seq_len, args.label_len, args.pred_len,args.batch_size,
            args.n_heads, args.attn, args.factor, 
            args.distil, args.is_padding,args.data_augmentation,args.is_descrsing,args.is_perception,args.normal_style,args.des,ii)
    ...
    setting_analysis_name = '{}_sl{}ll{}pl{}bs{}nh{}at{}fc{}dt{}ispa{}ag{}de{}pe{}nor{}_{}'.format(args.model,
                args.seq_len, args.label_len, args.pred_len,args.batch_size,
                args.n_heads, args.attn, args.factor, 
                args.distil, args.is_padding,args.data_augmentation,args.is_descrsing,args.is_perception,args.normal_style,args.des)
    def results_analysis(flag):
        ...
        for k in range(args.itr):  #args.itr
            ...
            metrics = np.load('./results/{}/metrics_{}.npy'.format(file_name,flag))
    ...
    test_results.to_csv('./results_analyse/{}.csv'.format(setting_analysis_name),index = True, header = True)
...
Results_means.to_csv('./results_analyse/Means_results_{}.csv'.format(setting_analysis_name),index = True, header = True)
